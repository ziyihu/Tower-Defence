...
public class EnemySpawnManager2 : MonoBehaviour {
	...
	public static EnemySpawnManager2 _instance;
	...
	private IEnumerator CreateEnemy(string enemyName, int number){
		...
		for(int i = 0 ; i < number ; i++){
			EnemySpawnManager._instance.enemyList.Add(enemySpawn.EnemyBorn(enemyName));
			yield return new WaitForSeconds(1f);
		}
		while (EnemySpawnManager._instance.enemyList.Count > 0) {
	...
	public void StartCoroutine2 () {
		StartCoroutine (Born1 ());
	}

	public void EndCoroutine2(){
		StopCoroutine (Born1 ());
	}
...
//		}
//		WaveAdd ();
		WaveManager._instance.SetCurrentWave (7);
		//7th wave enemy
		for (int i = 0; i < 5; i++) {
			EnemySpawnManager._instance.enemyList.Add (enemySpawn.EnemyBorn ("enemy18"));
			yield return new WaitForSeconds (1f);
		}
		for (int i = 0; i < 5; i++) {
			EnemySpawnManager._instance.enemyList.Add (enemySpawn.EnemyBorn ("enemy23"));
			yield return new WaitForSeconds (1f);
		}
		for (int i = 0; i < 10; i++) {
			EnemySpawnManager._instance.enemyList.Add (enemySpawn.EnemyBorn ("enemy26"));
			yield return new WaitForSeconds (1f);
		}
		while (EnemySpawnManager._instance.enemyList.Count > 0) {
			yield return new WaitForSeconds (0.2f);
		...
		//8th enemy
		for (int i = 0; i < 5; i++) {
			EnemySpawnManager._instance.enemyList.Add (enemySpawn.EnemyBorn ("enemy29"));
			yield return new WaitForSeconds (1f);
		}
		while (EnemySpawnManager._instance.enemyList.Count > 0) {
			yield return new WaitForSeconds (0.2f);
		...
		//10th wave enemy
		for (int i = 0; i < 5; i++) {
			EnemySpawnManager._instance.enemyList.Add (enemySpawn.EnemyBorn ("enemy40"));
			yield return new WaitForSeconds (1f);
		}
		while (EnemySpawnManager._instance.enemyList.Count > 0) {
			yield return new WaitForSeconds (0.2f);
		...
		//13th wave enemy
		for (int i = 0; i < 5; i++) {
			EnemySpawnManager._instance.enemyList.Add (enemySpawn.EnemyBorn ("enemy42"));
			yield return new WaitForSeconds (1f);
		}
		while (EnemySpawnManager._instance.enemyList.Count > 0) {
			yield return new WaitForSeconds (0.2f);
